...
<h1 align="center">LingPick — AI 工具決策引擎</h1>
<p align="center">
  <strong>AI 工具決策引擎</strong><br>
  找到真正好用又便宜的 AI 工具。
</p>

<p align="center">
  <a href="https://madapexai.com">網站</a> ·
  <a href="#-核心功能">功能</a> ·
  <a href="#-使用方式">使用</a> ·
  <a href="#-技術架構">架構</a> ·
  <a href="https://github.com/Madapexai/lingpick/discussions">討論</a>
</p>
...
LingPick 是一個 **AI 驅動的工具發現平台**，幫你用最低成本找到最合適的 AI 工具。我們索引了 **14,000+ 個 AI 工具**和 **400+ 個 AI 模型**，你不用再自己一個一個比較了。

> **痛點：** 開 50 個網頁分頁，做 3 張對比表格，花 2 小時 —— 就為了找一個不超過 $30/月的影片生成器。
...
1. 開啟 **[madapexai.com](https://madapexai.com)**
2. 在搜尋框輸入你想做的事
3. 即時取得結果
...
| 你輸入 | LingPick 找到 |
|--------|-------------|
| "做视频" | AI 影片工具、AIGC 影片創作、CogVideoX |
| "写代码" | 天工智碼 Skycode、碼上飛、Kimi K3 for Coding |
| "做PPT" | Dashi PPT、McKinsey PPT Design |
| "AI绘画" | 創客貼 AI 畫匠、秒繪 AI、繪蛙 AI |
| "数据分析" | 研究資料分析工具集 |
...
輸入以下任意關鍵字自動喚起 AI 助手：
`客服` `人工客服` `help` `support` `聯繫客服` `售後` `技術支援` `幫助` `求助` `回饋` `投訴` `complaint`
...
| **快取** | 三級快取（HOT 5 分鐘 / WARM 1 小時 / COLD 24 小時）+ 背景靜默重新整理 |
| **CI/CD** | GitHub Actions → Vercel（前端）+ Contabo PM2（後端） |
| **國際化** | 12 種語言翻譯檔案，en-US 備援，動態 html[lang] |

## 🤝 參與貢獻

- 📞 **[推薦工具](https://github.com/Madapexai/lingpick/discussions/categories/ideas)** — 我們漏掉了好工具？告訴我們。
- 🐛 **[回報問題](https://github.com/Madapexai/lingpick/discussions/categories/general)** — 發現 bug？來回饋。
- 💡 **[功能建議](https://github.com/Madapexai/lingpick/discussions/categories/ideas)** — 有好的想法讓 LingPick 更好用？
...
| 管道 | 連結 |
|------|------|
| 💬 Discussions | [討論區](https://github.com/Madapexai/lingpick/discussions) |
